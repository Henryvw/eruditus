## Action Items for Upcoming Sprint
...
|**What are interesting experiments?**|- change the study time to 90 min (or change second half to 90 min) <br> - extend the sprint to 6 weeks <br>- picking a smaller scope in a topic, trying to aim at wrapping things up after 4 learning days <br>- Actively invite people to the presentations <br>- have a week long sprint|- More dialogue in learning; <br>- Could we have even mini-presentations;<br> - Or simply you answer the question, what did I learn today?<br> - Multiple Learning Topics Running Simultaneously (for example, if we are doing 2 days a week) <br> - Creating systems so that multiple people with different schedules can participate: ![eruditus circles](https://github.com/Henryvw/eruditus/blob/master/images/eruditus-circles.png "Eruditus Circles - Multiple Schedules")|
